...
## Resistor
---
A resistor is an object that controls the flow of electricity, the current, between its two terminals. The property that obstructs current is called resistance. As resistance increases, more effort is required to produce a fixed current.
